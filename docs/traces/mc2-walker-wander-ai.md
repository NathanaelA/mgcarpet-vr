...
- **GAME_PAUSED** = bit 1 of OptionsSettingFlag, toggled by `PauseUnpauseGame_18BB0` (PlayerInput.cpp:406-417) and managed around menu-state transitions (GameUI.cpp:662-721). **Whether MC2's fullscreen map sets it is unverified — BANKED**; if it does, all map-dot observations sample a frozen world.
